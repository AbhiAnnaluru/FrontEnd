      ...
      const resultData = [];
        for(const key in res){
          resultData.push({cacm_id:res[key].cacm_id,
                            ...
                            edi_old_isin:res[key].edi_old_isin,
                            edi_new_isin:res[key].edi_new_isin,
                            edi_old_ticker:res[key].edi_old_ticker,
                            edi_new_ticker:res[key].edi_new_ticker,
                            edi_old_issuer:res[key].edi_old_issuer,
                            edi_new_issuer:res[key].edi_new_issuer,
                            edi_old_listing:res[key].edi_old_listing,
                            edi_new_listing:res[key].edi_old_listing,
