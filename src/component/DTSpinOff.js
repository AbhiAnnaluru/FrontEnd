...
export default function MaterialTableDemo() {
  ...
  const [state, setState] = React.useState({
    columns: [
      ...
      { title: 'Adjustment_Factor', field: 'edi_adjustment_factor' },
      { title: 'Spin_off_name', field: 'spunoff_name' },
      { title: 'Spin_off_ticker', field: 'spunoff_name_ticker' },
      ...
      const resultData = [];
        for(const key in res){
          resultData.push({cacm_id:res[key].cacm_id,
                            ...
                            edi_adjustment_factor:res[key].edi_adjustment_factor,
                            spunoff_name:res[key].spunoff_name,
                            spunoff_name_ticker:res[key].spunoff_name_ticker,
